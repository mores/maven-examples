 ...
 * @version 0.1
 */
public class ComplexSeries extends DataGenerator {
	 ...
	 * @param String save 
	 */
	public ComplexSeries(int iterations, String save) {
	 ...
	 * 
	 */
	public ComplexSeries(String file1, String file2, String file3,
	...
	public static void main(String[] args) {
		...
		for (int idx=0; idx < filecount; idx++) {
			String aname = tbase + idx + ext;
			ComplexSeries cs = new ComplexSeries(f,l,s,c,st,p,aname,count);
			cs.generate();
		}
