...
public class PriceRuleDiscountCodeUpdatePayload {
  ...
  public PriceRuleDiscountCodeUpdatePayload() {
  }
  ...
  public String toString() {
    return "PriceRuleDiscountCodeUpdatePayload{priceRule='" + priceRule + "', priceRuleDiscountCode='" + priceRuleDiscountCode + "', priceRuleUserErrors='" + priceRuleUserErrors + "', userErrors='" + userErrors + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    PriceRuleDiscountCodeUpdatePayload that = (PriceRuleDiscountCodeUpdatePayload) o;
  ...
  public static class Builder {
    ...
    public PriceRuleDiscountCodeUpdatePayload build() {
      PriceRuleDiscountCodeUpdatePayload result = new PriceRuleDiscountCodeUpdatePayload();
