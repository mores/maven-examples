...
public class PriceRuleEntitlementToPrerequisiteQuantityRatioInput {
  ...
  public PriceRuleEntitlementToPrerequisiteQuantityRatioInput() {
  }
  ...
  public String toString() {
    return "PriceRuleEntitlementToPrerequisiteQuantityRatioInput{entitlementQuantity='" + entitlementQuantity + "', prerequisiteQuantity='" + prerequisiteQuantity + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    PriceRuleEntitlementToPrerequisiteQuantityRatioInput that = (PriceRuleEntitlementToPrerequisiteQuantityRatioInput) o;
  ...
  public static class Builder {
    ...
    public PriceRuleEntitlementToPrerequisiteQuantityRatioInput build() {
      PriceRuleEntitlementToPrerequisiteQuantityRatioInput result = new PriceRuleEntitlementToPrerequisiteQuantityRatioInput();
