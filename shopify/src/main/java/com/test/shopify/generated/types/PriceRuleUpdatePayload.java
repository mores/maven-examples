...
public class PriceRuleUpdatePayload {
  ...
  public String toString() {
    return "PriceRuleUpdatePayload{priceRule='" + priceRule + "', priceRuleDiscountCode='" + priceRuleDiscountCode + "', priceRuleUserErrors='" + priceRuleUserErrors + "', userErrors='" + userErrors + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    PriceRuleUpdatePayload that = (PriceRuleUpdatePayload) o;
  ...
  public static class Builder {
    ...
    public PriceRuleUpdatePayload build() {
      PriceRuleUpdatePayload result = new PriceRuleUpdatePayload();
