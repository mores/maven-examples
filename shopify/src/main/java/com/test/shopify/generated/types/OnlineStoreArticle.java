...
public class OnlineStoreArticle implements MetafieldReferencer, com.test.shopify.generated.types.HasPublishedTranslations, com.test.shopify.generated.types.Navigable, com.test.shopify.generated.types.Node {
  /**
  ...
  public String toString() {
    return "OnlineStoreArticle{defaultCursor='" + defaultCursor + "', id='" + id + "', translations='" + translations + "'}";
  }
  ...
  public boolean equals(Object o) {
    ...
    OnlineStoreArticle that = (OnlineStoreArticle) o;
  ...
  public static class Builder {
    ...
    public OnlineStoreArticle build() {
      OnlineStoreArticle result = new OnlineStoreArticle();
